...
class Container(containers.DeclarativeContainer):
    ...
    activity_repository = providers.Factory(ActivityRepository, db_adapter=database_adapter)
    ...
    region_service = providers.Factory(RegionService, region_repository=region_repository)

    activity_service = providers.Factory(ActivityService, activity_repository=activity_repository)
