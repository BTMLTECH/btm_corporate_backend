...
from .endpoints.destination import router as destination_router

routers = APIRouter()
router_list = [auth_router, accommodation_router, activity_router, user_router, region_router, transportation_router, tour_package_router, payment_router, destination_router]
