#!/usr/bin/env python3
# File: services/user_tour_package_service.py
# Author: Oluwatobiloba Light
"""User Tour package Services"""
...
class UserTourPackageService(BaseService):
    def __init__(self, user_tour_package_repository: UserTourPackageRepository):
        self.tour_package_repository = user_tour_package_repository

        super().__init__(user_tour_package_repository)
