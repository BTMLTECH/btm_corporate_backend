#!/usr/bin/env python3
# File: app/mode/exclusion.py
# Author: Oluwatobiloba Light
# Date created: 29/05/2025
"""Tour package Exclusion model"""
...
class Exclusion(BaseModel, table=True):
    ___tablename__: str = "tour_package_exclusions"
    ...
    tour_package_id: UUID = Field(
     ...
     # --- Relationships ---
    tour_package: Optional["TourPackage"] = Relationship(back_populates="exclusions")
